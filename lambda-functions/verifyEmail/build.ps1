...
Remove-Item verifyEmail.zip -ErrorAction SilentlyContinue
...
cd package
Compress-Archive -Path * -DestinationPath ../verifyEmail.zip -Force
cd ..

Write-Host "✅ Package built: verifyEmail.zip"