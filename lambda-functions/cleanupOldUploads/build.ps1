...
Remove-Item cleanUpOldUploads.zip -ErrorAction SilentlyContinue
...
cd package
Compress-Archive -Path * -DestinationPath ../cleanUpOldUploads.zip -Force
cd ..

Write-Host "✅ Package built: cleanUpOldUploads.zip"