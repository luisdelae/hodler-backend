...
Remove-Item generateUploadUrl.zip -ErrorAction SilentlyContinue
...
cd package
Compress-Archive -Path * -DestinationPath ../generateUploadUrl.zip -Force
cd ..

Write-Host "✅ Package built: generateUploadUrl.zip"